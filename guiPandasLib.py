...
def bgcolor():
	...
	if Dark_Mode == False:
		...
		style.configure("Treeview.Heading",background="#BB86FC", foreground="#121212", relief="raised", font='Arial 12 bold')
		...
		style.map('TButton',background=[('selected','#BB86FC'), ('active', '#03DAC5')],foreground=[('selected','#020202'), ('active', '#121212')])
		...
		style.configure("Treeview.Heading",background="#6200EE", foreground="#ffffff", relief="round")
		...
		# LabelFrame color change
		style.configure('TLabelframe', background='#fdfdfd', foreground = '#000000' )
